...
## 2. Capacity and load estimates

### 2.1 User and run volume
...
### 2.2 LLM tokens and model gateway QPS
...
### 2.5 Vector store retrieval QPS
...
### 2.6 Instance sizing on m8g family
